...
const _sfc_main = {
  ...
  methods: {
    setChart(callback) {
      if (!this.chart) {
        common_vendor.index.__f__("warn", "at uni_modules/lime-echart/components/l-echart/l-echart.vue:218", `组件还未初始化，请先使用 init`);
        return;
      }
    ...
    setOption() {
      if (!this.chart || !this.chart.setOption) {
        common_vendor.index.__f__("warn", "at uni_modules/lime-echart/components/l-echart/l-echart.vue:232", `组件还未初始化，请先使用 init`);
        return;
      }
    ...
    async init(echarts, ...args) {
      if (args && args.length == 0 && !echarts) {
        common_vendor.index.__f__("error", "at uni_modules/lime-echart/components/l-echart/l-echart.vue:315", "缺少参数：init(echarts, theme?:string, opts?: object, callback?: function)");
        return;
      }
      ...
      try {
        ...
        common_vendor.index.__f__("error", "at uni_modules/lime-echart/components/l-echart/l-echart.vue:347", e.messges);
        return null;
      }
    },
    getContext() {
